...
namespace InsurancePortal.Areas.Manage.Controllers
{
    ...
    public class ContactsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("QueryId,Name,Email,PhoneNumber,Message")] Contact contact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("QueryId,Name,Email,PhoneNumber,Message")] Contact contact)
        {
            if (id != contact.QueryId)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!ContactExists(contact.QueryId))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.Contacts.Any(e => e.QueryId == id);
        }
    }
}
